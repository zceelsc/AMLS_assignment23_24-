...
class Net(nn.Module):
    def __init__(self, in_channels, num_classes):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(in_channels, 16, kernel_size=3, stride=2, padding=1), nn.BatchNorm2d(16), nn.ReLU())
        ...
        self.fc1 = nn.Linear(1024, 256)  # Adjusted the input size based on the modified structure
...
torch.save(model.state_dict(), 'B_trained_model.pth')
...
model.load_state_dict(torch.load('B_trained_model.pth'))
